...
Garages = {
    ...
    ["cartel"] = {
        label = "Cartel",
        takeVehicle = vector3(1507.18, 1118.04, 114.84),
    ...
    ["kebunanggur"] = {
        label = "Kebun Anggur",
        takeVehicle = vector3(-1919.21, 2052.5, 140.74),
        spawnPoint = vector4(-1920.77, 2048.54, 140.74, 260.66),
        putVehicle = vector3(-1920.77, 2048.54, 140.74),
        showBlip = true,
        blipName = "Kebun Anggur",
        blipNumber = 356,
        type = 'public',                --public, job, gang, depot
        vehicle = 'car'                 --car, air, sea
    },
